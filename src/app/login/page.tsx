...
export default function LoginPage() {
  ...
  useEffect(() => {
    // Captura mensagens de sucesso vindas do redirecionamento do cadastro
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    // Busca o perfil na nossa tabela pública para saber se é admin ou cliente comum
    ...
    // Se for administrador, manda direto para o painel gerenciador!
